...
/**
 * Unit tests for TypeScriptLspCompletionItem.
 */
class TypeScriptLspCompletionItemTest {
    ...
    void testConstruction() {
        ...
        TypeScriptLspCompletionItem item = new TypeScriptLspCompletionItem(mockCompletion, 10);
    ...
    void testGetSortPriority() {
        ...
        TypeScriptLspCompletionItem item = new TypeScriptLspCompletionItem(mockCompletion, 0);
