...
/**
 * Unit tests for TypeScriptProject.
 */
class TypeScriptProjectTest {

    private TypeScriptProject project;
    ...
    void setUp() {
        ...
        project = new TypeScriptProject(mockDir, mockState);
    }

    @Test
    void testGetLanguageName() {
        assertThat(project.getLanguageName()).isEqualTo("TypeScript");
    }

    @Test
    void testGetIconPath() {
        assertThat(project.getIconPath()).isEqualTo("org/flossware/netbeans/typescript/resources/typescript-icon.png");
    }
