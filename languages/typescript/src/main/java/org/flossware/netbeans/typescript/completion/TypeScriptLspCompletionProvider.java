...
import org.flossware.netbeans.typescript.lsp.TypeScriptLspServerLauncher;
import org.netbeans.api.editor.mimelookup.MimeRegistration;
import org.netbeans.spi.editor.completion.CompletionProvider;

/**
 * TypeScript code completion provider using Language Server Protocol.
 *
 * <p>Provides intelligent code completion for TypeScript files by communicating
 * with a TypeScript language server via LSP.</p>
 *
 ...
 *   <li>TypeScript language server installed (typescript-language-server)</li>
 * </ul>
 *
 * @author FlossWare
 * @version 1.0
 * @since 1.0
 */
@MimeRegistration(mimeType = "text/x-typescript", service = CompletionProvider.class)
public class TypeScriptLspCompletionProvider extends AbstractLspCompletionProvider {

    private static final Logger LOGGER = Logger.getLogger(TypeScriptLspCompletionProvider.class.getName());
    ...
    protected AbstractLspCompletionQuery createCompletionQuery() {
        return new TypeScriptLspCompletionQuery();
    }
    ...
    protected boolean isLspServerAvailable() {
        ...
        // Then check if TypeScript LSP server is installed
        TypeScriptLspServerLauncher launcher = new TypeScriptLspServerLauncher();
