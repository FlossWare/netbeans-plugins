...
/**
 * NetBeans TypeScript Project representation.
 *
 * <p>Recognized by presence of TypeScript project files (tsconfig.json, package.json, etc.).
 ...
 */
public class TypeScriptProject extends AbstractProject {

    /**
     * Create a new TypeScript project instance.
     *
     * @param projectDir The project directory
     * @param state The project state
     */
    public TypeScriptProject(FileObject projectDir, ProjectState state) {
