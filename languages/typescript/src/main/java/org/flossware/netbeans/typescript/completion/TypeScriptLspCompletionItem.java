...
/**
 * NetBeans completion item backed by LSP completion data for TypeScript.
 *
 * <p>Represents a single code completion suggestion from the TypeScript language server,
 ...
 * @since 1.0
 */
public class TypeScriptLspCompletionItem extends AbstractLspCompletionItem {
     ...
     */
    public TypeScriptLspCompletionItem(Completion lspCompletion, int caretOffset) {
