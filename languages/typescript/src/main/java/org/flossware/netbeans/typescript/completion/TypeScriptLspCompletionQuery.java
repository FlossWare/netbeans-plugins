...
/**
 * Asynchronous completion query that retrieves code completions from TypeScript LSP server.
 *
 * <p>This class queries the TypeScript language server for code
 ...
 * @since 1.0
 */
public class TypeScriptLspCompletionQuery extends AbstractLspCompletionQuery {
