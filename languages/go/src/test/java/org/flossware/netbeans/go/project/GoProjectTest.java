...
class GoProjectTest {
    ...
    void setUp() {
        ...
        project = new GoProject(mockDir, mockState);
    }

    @Test
    void testGetLanguageName() {
        assertThat(project.getLanguageName()).isEqualTo("Go");
    }

    @Test
    void testGetIconPath() {
        assertThat(project.getIconPath()).isEqualTo("org/flossware/netbeans/go/resources/go-icon.png");
    }
