...
/**
 * Unit tests for GoLspCompletionItem.
 */
class GoLspCompletionItemTest {
    ...
    void testConstruction() {
        ...
        GoLspCompletionItem item = new GoLspCompletionItem(mockCompletion, 10);
    ...
    void testGetSortPriority() {
        ...
        GoLspCompletionItem item = new GoLspCompletionItem(mockCompletion, 0);
