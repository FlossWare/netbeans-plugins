...
import org.flossware.netbeans.go.lsp.GoLspServerLauncher;
import org.netbeans.api.editor.mimelookup.MimeRegistration;
import org.netbeans.spi.editor.completion.CompletionProvider;

/**
 * Go code completion provider using Language Server Protocol.
 *
 * <p>Provides intelligent code completion for Go files by communicating
 * with the Go language server (gopls) via LSP.</p>
 *
 * <p>Features provided by LSP server:</p>
 * <ul>
 *   <li>Symbol completion (variables, functions, types)</li>
 ...
 *   <li>Go LSP server installed (gopls)</li>
 * </ul>
 *
 * @author FlossWare
 * @version 1.0
...
public class GoLspCompletionProvider extends AbstractLspCompletionProvider {

    private static final Logger LOGGER = Logger.getLogger(GoLspCompletionProvider.class.getName());
    ...
    protected AbstractLspCompletionQuery createCompletionQuery() {
        return new GoLspCompletionQuery();
    }
    ...
    protected boolean isLspServerAvailable() {
        ...
        // Then check if Go LSP server is installed
        GoLspServerLauncher launcher = new GoLspServerLauncher();
