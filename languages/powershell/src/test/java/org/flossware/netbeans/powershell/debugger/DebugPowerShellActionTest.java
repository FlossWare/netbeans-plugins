...
class DebugPowerShellActionTest {
    ...
    private DebugPowerShellAction action;

    @BeforeEach
    void setUp() {
        action = new DebugPowerShellAction(mockDataObject);
    }
    ...
    // Note: testActionPerformed tests are commented out because they require PowerShell to be installed
    /*
    @Test
