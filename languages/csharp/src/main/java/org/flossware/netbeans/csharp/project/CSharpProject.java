...
/**
 * NetBeans C# Project representation.
 *
 * <p>Recognized by presence of C# project files (.csproj, .sln, etc.).
 ...
 */
public class CSharpProject extends AbstractProject {

    /**
     * Create a new C# project instance.
     *
     * @param projectDir The project directory
     * @param state The project state
     */
    public CSharpProject(FileObject projectDir, ProjectState state) {
