...
/**
 * Asynchronous completion query that retrieves code completions from C# LSP server.
 *
 * <p>This class queries the C# language server (OmniSharp) for code
 ...
 * @since 1.0
 */
public class CSharpLspCompletionQuery extends AbstractLspCompletionQuery {
