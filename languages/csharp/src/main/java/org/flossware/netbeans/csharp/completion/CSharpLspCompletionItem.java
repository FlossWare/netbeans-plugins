...
/**
 * NetBeans completion item backed by LSP completion data for C#.
 *
 * <p>Represents a single code completion suggestion from the C# language server,
 ...
 * @since 1.0
 */
public class CSharpLspCompletionItem extends AbstractLspCompletionItem {
     ...
     */
    public CSharpLspCompletionItem(Completion lspCompletion, int caretOffset) {
