...
import org.flossware.netbeans.csharp.lsp.CSharpLspServerLauncher;
import org.netbeans.api.editor.mimelookup.MimeRegistration;
import org.netbeans.spi.editor.completion.CompletionProvider;

/**
 * C# code completion provider using Language Server Protocol.
 *
 * <p>Provides intelligent code completion for C# files by communicating
 * with a C# language server (OmniSharp) via LSP.</p>
 *
 * <p>Features provided by LSP server:</p>
 * <ul>
 *   <li>Symbol completion (variables, functions, classes)</li>
 *   <li>Namespace/using imports</li>
 ...
 *   <li>C# LSP server installed (OmniSharp)</li>
 * </ul>
 *
 * @author FlossWare
 * @version 1.0
...
public class CSharpLspCompletionProvider extends AbstractLspCompletionProvider {

    private static final Logger LOGGER = Logger.getLogger(CSharpLspCompletionProvider.class.getName());
    ...
    protected AbstractLspCompletionQuery createCompletionQuery() {
        return new CSharpLspCompletionQuery();
    }
    ...
    protected boolean isLspServerAvailable() {
        ...
        // Then check if C# LSP server is installed
        CSharpLspServerLauncher launcher = new CSharpLspServerLauncher();
