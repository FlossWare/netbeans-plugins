...
/**
 * Unit tests for CSharpProjectFactory.
 */
class CSharpProjectFactoryTest {

    private CSharpProjectFactory factory;

    @BeforeEach
    void setUp() {
        factory = new CSharpProjectFactory();
    }
    ...
    void testGetFileExtension() {
        assertThat(factory.getFileExtension()).isEqualTo("cs");
    }
    ...
    void testCreateProjectInstance() {
        ...
        assertThat(factory.createProjectInstance(mockDir, mockState))
            .isInstanceOf(CSharpProject.class);
    }
}
