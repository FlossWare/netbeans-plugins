...
/**
 * Unit tests for CSharpProject.
 */
class CSharpProjectTest {

    private CSharpProject project;
    ...
    void setUp() {
        ...
        project = new CSharpProject(mockDir, mockState);
    }

    @Test
    void testGetLanguageName() {
        assertThat(project.getLanguageName()).isEqualTo("C#");
    }

    @Test
    void testGetIconPath() {
        assertThat(project.getIconPath()).isEqualTo("org/flossware/netbeans/csharp/resources/csharp-icon.png");
    }
