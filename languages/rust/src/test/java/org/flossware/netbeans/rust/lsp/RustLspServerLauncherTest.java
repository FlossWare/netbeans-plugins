...
/**
 * Unit tests for RustLspServerLauncher.
 */
class RustLspServerLauncherTest {

    private RustLspServerLauncher launcher;

    @BeforeEach
    void setUp() {
        launcher = new RustLspServerLauncher();
    }
    ...
    void testGetServerCommands() {
        ...
        assertThat(commands).contains("rust-analyzer");
    }
    ...
    void testGetInstallationInstructions() {
        ...
        assertThat(instructions).contains("rust-analyzer");
    }
