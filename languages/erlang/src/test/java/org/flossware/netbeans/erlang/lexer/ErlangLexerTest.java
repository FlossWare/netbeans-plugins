...
class ErlangLexerTest {
    @Test
    void testKeywordRecognition() throws Exception {
        String text = "if else";
        TokenHierarchy<?> hi = TokenHierarchy.create(text, ErlangTokenId.language());
        TokenSequence<ErlangTokenId> ts = hi.tokenSequence(ErlangTokenId.language());
