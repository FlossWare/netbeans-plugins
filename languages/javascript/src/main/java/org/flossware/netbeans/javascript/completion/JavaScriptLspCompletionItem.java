...
/**
 * NetBeans completion item backed by LSP completion data for JavaScript.
 *
 * <p>Represents a single code completion suggestion from the JavaScript language server,
 ...
 * @since 1.0
 */
public class JavaScriptLspCompletionItem extends AbstractLspCompletionItem {
     ...
     */
    public JavaScriptLspCompletionItem(Completion lspCompletion, int caretOffset) {
