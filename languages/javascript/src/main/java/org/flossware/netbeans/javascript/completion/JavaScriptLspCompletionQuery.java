...
/**
 * Asynchronous completion query that retrieves code completions from JavaScript LSP server.
 *
 * <p>This class queries the JavaScript language server for code
 ...
 * @since 1.0
 */
public class JavaScriptLspCompletionQuery extends AbstractLspCompletionQuery {
