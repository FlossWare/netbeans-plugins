...
/**
 * NetBeans JavaScript Project representation.
 *
 * <p>Recognized by presence of JavaScript project files (package.json, etc.).
 ...
 */
public class JavaScriptProject extends AbstractProject {

    /**
     * Create a new JavaScript project instance.
     *
     * @param projectDir The project directory
     * @param state The project state
     */
    public JavaScriptProject(FileObject projectDir, ProjectState state) {
