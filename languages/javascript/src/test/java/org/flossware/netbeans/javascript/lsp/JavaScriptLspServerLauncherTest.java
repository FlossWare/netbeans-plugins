...
/**
 * Unit tests for JavaScriptLspServerLauncher.
 */
class JavaScriptLspServerLauncherTest {

    private JavaScriptLspServerLauncher launcher;

    @BeforeEach
    void setUp() {
        launcher = new JavaScriptLspServerLauncher();
    }
