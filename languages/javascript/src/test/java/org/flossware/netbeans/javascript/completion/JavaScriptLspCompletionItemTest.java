...
/**
 * Unit tests for JavaScriptLspCompletionItem.
 */
class JavaScriptLspCompletionItemTest {
    ...
    void testConstruction() {
        ...
        JavaScriptLspCompletionItem item = new JavaScriptLspCompletionItem(mockCompletion, 10);
    ...
    void testGetSortPriority() {
        ...
        JavaScriptLspCompletionItem item = new JavaScriptLspCompletionItem(mockCompletion, 0);
