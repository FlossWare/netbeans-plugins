...
/**
 * Unit tests for JavaScriptProject.
 */
class JavaScriptProjectTest {
    ...
    void setUp() {
        ...
        project = new JavaScriptProject(mockDir, mockState);
    }

    @Test
    void testGetLanguageName() {
        assertThat(project.getLanguageName()).isEqualTo("JavaScript");
    }

    @Test
    void testGetIconPath() {
        assertThat(project.getIconPath()).isEqualTo("org/flossware/netbeans/javascript/resources/javascript-icon.png");
    }
