...
class DebugZshActionTest {
    ...
    private DebugZshAction action;

    @BeforeEach
    void setUp() {
        action = new DebugZshAction(mockDataObject);
    }
    ...
    // Note: testActionPerformed tests are commented out because they require zsh debugger to be installed
    /*
    @Test
