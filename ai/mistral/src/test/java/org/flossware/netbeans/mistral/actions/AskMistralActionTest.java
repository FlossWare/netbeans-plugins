...
class AskMistralActionTest {

    @Mock
    private JTextComponent mockComponent;

    private AskMistralAction action;

    @BeforeEach
    void setUp() {
        action = new AskMistralAction(mockComponent);
    }
    ...
    void testConstruction_NullComponent() {
        AskMistralAction nullAction = new AskMistralAction(null);
