...
/**
 * Panel for Mistral options
 */
final class MistralOptionsPanel extends JPanel {
    ...
    private final MistralOptionsPanelController controller;
    private JPasswordField apiKeyField;
    private JComboBox<String> modelComboBox;
    private JSpinner maxTokensSpinner;
    private JSpinner temperatureSpinner;

    MistralOptionsPanel(MistralOptionsPanelController controller) {
    ...
    private void initComponents() {
        ...
        gbc.gridx = 1;
        gbc.gridy = 1;
        JLabel helpLabel = new JLabel("<html><small>Get your API key from <a href='https://console.mistral.ai/'>console.mistral.ai</a></small></html>");
    ...
    void store() {
        ...
        MistralService.getInstance().getClient().setApiKey(new String(apiKeyField.getPassword()));
    }
