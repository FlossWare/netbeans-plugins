...
/**
 * Panel for Cohere options
 */
final class CohereOptionsPanel extends JPanel {
    ...
    private final CohereOptionsPanelController controller;
    private JPasswordField apiKeyField;
    private JComboBox<String> modelComboBox;
    private JSpinner maxTokensSpinner;
    private JSpinner temperatureSpinner;

    CohereOptionsPanel(CohereOptionsPanelController controller) {
    ...
    private void initComponents() {
        ...
        gbc.gridx = 1;
        gbc.gridy = 1;
        JLabel helpLabel = new JLabel("<html><small>Get your API key from <a href='https://console.cohere.ai/'>console.cohere.ai</a></small></html>");
    ...
    void load() {
        Preferences prefs = NbPreferences.forModule(CohereOptionsPanel.class);
        apiKeyField.setText(prefs.get(PREF_API_KEY, ""));
        modelComboBox.setSelectedItem(prefs.get(PREF_MODEL, "cohere-small-latest"));
    ...
    void store() {
        ...
        CohereService.getInstance().getClient().setApiKey(new String(apiKeyField.getPassword()));
    }
    ...
    private void testConnection() {
        ...
        // Test the connection
        CohereService service = CohereService.getInstance();
