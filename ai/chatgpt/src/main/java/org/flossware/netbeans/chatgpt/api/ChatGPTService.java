...
/**
 * Service layer for ChatGPT API interactions
...
public class ChatGPTService {
    ...
    private ChatGPTService() {
        ...
        this.requestProcessor = new RequestProcessor("ChatGPT API", 3);
    }

    public static synchronized ChatGPTService getInstance() {
        if (instance == null) {
