...
class ChatGPTServiceTest {
    ...
    @Mock
    private ChatGPTClient mockClient;

    @BeforeEach
    void setUp() {
        // Reset singleton for each test
        try {
            java.lang.reflect.Field instance = ChatGPTService.class.getDeclaredField("instance");
        ...
        try {
            java.lang.reflect.Field client = ChatGPTService.class.getDeclaredField("client");
    ...
    void testGetInstance_ReturnsSameInstance() {
        ChatGPTService instance1 = ChatGPTService.getInstance();
        ChatGPTService instance2 = ChatGPTService.getInstance();
    ...
    void testSendMessageAsync_Success() throws Exception {
        String expectedResponse = "Hello from ChatGPT!";
    ...
    @Test
    void testGetClient() {
        ChatGPTClient client = service.getClient();
