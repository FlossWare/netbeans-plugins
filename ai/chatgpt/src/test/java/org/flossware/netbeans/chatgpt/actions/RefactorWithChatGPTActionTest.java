...
class RefactorWithChatGPTActionTest {
    ...
    void testConstruction_NullComponent() {
        RefactorWithChatGPTAction nullAction = new RefactorWithChatGPTAction(null);
