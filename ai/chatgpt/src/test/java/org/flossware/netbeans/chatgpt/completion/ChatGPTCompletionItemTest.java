...
class ChatGPTCompletionItemTest {

    @Test
    void testConstruction() {
        ChatGPTCompletionItem item = new ChatGPTCompletionItem("text", "prefix", 10, 0);
        assertThat(item).isNotNull();
    }

    @Test
    void testGetSortPriority() {
        ChatGPTCompletionItem item = new ChatGPTCompletionItem("text", "prefix", 10, 5);
        assertThat(item.getSortPriority()).isEqualTo(5);
    }

    @Test
    void testGetSortText() {
        ChatGPTCompletionItem item = new ChatGPTCompletionItem("myText", "prefix", 10, 0);
        assertThat(item.getSortText()).isEqualTo("myText");
    }

    @Test
    void testGetInsertPrefix() {
        ChatGPTCompletionItem item = new ChatGPTCompletionItem("insertMe", "prefix", 10, 0);
        assertThat(item.getInsertPrefix()).isEqualTo("insertMe");
    }

    @Test
    void testDefaultAction_ValidComponent() throws Exception {
        ChatGPTCompletionItem item = new ChatGPTCompletionItem("newText", "old", 3, 0);
    ...
    void testLongText_Truncation() {
        ...
        ChatGPTCompletionItem item = new ChatGPTCompletionItem(longText, "prefix", 10, 0);
        assertThat(item).isNotNull();
    }
    ...
    void testMultilineText() {
        ...
        ChatGPTCompletionItem item = new ChatGPTCompletionItem(multilineText, "prefix", 10, 0);
        assertThat(item).isNotNull();
    }

    @Test
    void testEmptyPrefix() {
        ChatGPTCompletionItem item = new ChatGPTCompletionItem("text", "", 0, 0);
    ...
    void testNegativePriority() {
        ChatGPTCompletionItem item = new ChatGPTCompletionItem("text", "prefix", 10, -1);
