...
/**
 * Service layer for DeepSeek API interactions
...
public class DeepSeekService {
    ...
    private DeepSeekService() {
        ...
        this.requestProcessor = new RequestProcessor("DeepSeek API", 3);
    }

    public static synchronized DeepSeekService getInstance() {
        if (instance == null) {
