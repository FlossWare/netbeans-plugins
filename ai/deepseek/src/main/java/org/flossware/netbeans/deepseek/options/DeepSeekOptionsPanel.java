...
/**
 * Panel for DeepSeek options
 */
final class DeepSeekOptionsPanel extends JPanel {

    private static final String PREF_API_KEY = "deepseek.api.key";
    private static final String PREF_MODEL = "deepseek.model";
    private static final String PREF_MAX_TOKENS = "deepseek.max.tokens";
    private static final String PREF_TEMPERATURE = "deepseek.temperature";

    private final DeepSeekOptionsPanelController controller;
    private JPasswordField apiKeyField;
    private JComboBox<String> modelComboBox;
    private JSpinner maxTokensSpinner;
    private JSpinner temperatureSpinner;

    DeepSeekOptionsPanel(DeepSeekOptionsPanelController controller) {
    ...
    private void initComponents() {
        ...
        gbc.gridx = 1;
        gbc.gridy = 1;
        JLabel helpLabel = new JLabel("<html><small>Get your API key from <a href='https://console.deepseek.ai/'>console.deepseek.ai</a></small></html>");
        ...
        modelComboBox = new JComboBox<>(new String[]{
            "deepseek-large-latest",
            "deepseek-medium-latest",
            "deepseek-small-latest",
            "codestral-latest"
        });
    ...
    void load() {
        Preferences prefs = NbPreferences.forModule(DeepSeekOptionsPanel.class);
        apiKeyField.setText(prefs.get(PREF_API_KEY, ""));
        modelComboBox.setSelectedItem(prefs.get(PREF_MODEL, "deepseek-large-latest"));
    ...
    void store() {
        ...
        DeepSeekService.getInstance().getClient().setApiKey(new String(apiKeyField.getPassword()));
    }
