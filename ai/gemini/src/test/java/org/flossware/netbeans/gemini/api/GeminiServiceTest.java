...
class GeminiServiceTest {
    ...
    void setUp() {
        ...
        try {
            java.lang.reflect.Field instance = GeminiService.class.getDeclaredField("instance");
        ...
        try {
            java.lang.reflect.Field client = GeminiService.class.getDeclaredField("client");
    ...
    void testGetInstance_ReturnsSameInstance() {
        GeminiService instance1 = GeminiService.getInstance();
        GeminiService instance2 = GeminiService.getInstance();
    ...
    void testSendMessageAsync_Success() throws Exception {
        String expectedResponse = "Hello from Gemini!";
    ...
    @Test
    void testGetClient() {
        GeminiClient client = service.getClient();
