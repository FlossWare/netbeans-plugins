...
/**
 * Individual completion item from Gemini
 */
public class GeminiCompletionItem implements CompletionItem {
    ...
    public GeminiCompletionItem(String text, String prefix, int caretOffset, int priority) {
        this.text = text;
        this.prefix = prefix;
    ...
    private static ImageIcon loadIcon() {
        // Try to load Gemini icon, fallback to default
        ImageIcon icon = ImageUtilities.loadImageIcon(
                "org/flossware/netbeans/gemini/resources/gemini-icon.png", false);
        return icon;
    }
    ...
    public CompletionTask createDocumentationTask() {
        return new GeminiCompletionDocumentation(text);
    }
