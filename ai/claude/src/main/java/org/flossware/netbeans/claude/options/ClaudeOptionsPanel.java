...
import org.flossware.netbeans.claude.completion.ClaudeCompletionSettings;
import org.openide.util.NbPreferences;

/**
 * Panel for Claude options
 */
final class ClaudeOptionsPanel extends JPanel {
    ...
    private final ClaudeOptionsPanelController controller;
    ...
    ClaudeOptionsPanel(ClaudeOptionsPanelController controller) {
    ...
    private void initComponents() {
        ...
        gbc.gridx = 1;
        gbc.gridy = 1;
        JLabel helpLabel = new JLabel("<html><small>Get your API key from <a href='https://console.anthropic.com/'>console.anthropic.com</a></small></html>");
    ...
    void load() {
        Preferences prefs = NbPreferences.forModule(ClaudeOptionsPanel.class);
        apiKeyField.setText(prefs.get(PREF_API_KEY, ""));
        modelComboBox.setSelectedItem(prefs.get(PREF_MODEL, "claude-sonnet-4-5@20250929"));
        ...
        enableCompletionCheckBox.setSelected(ClaudeCompletionSettings.isEnabled());
        autoTriggerCheckBox.setSelected(ClaudeCompletionSettings.isAutoTriggerEnabled());
        minCharsSpinner.setValue(ClaudeCompletionSettings.getMinimumCharacters());
        triggerCharsField.setText(ClaudeCompletionSettings.getTriggerCharacters());
        enableCacheCheckBox.setSelected(ClaudeCompletionSettings.isCacheEnabled());
    ...
    void store() {
        ...
        ClaudeCompletionSettings.setEnabled(enableCompletionCheckBox.isSelected());
        ClaudeCompletionSettings.setAutoTriggerEnabled(autoTriggerCheckBox.isSelected());
        ClaudeCompletionSettings.setMinimumCharacters((Integer) minCharsSpinner.getValue());
        ClaudeCompletionSettings.setTriggerCharacters(triggerCharsField.getText());
        ClaudeCompletionSettings.setCacheEnabled(enableCacheCheckBox.isSelected());

        // Update the service with new API key
        ClaudeService.getInstance().getClient().setApiKey(new String(apiKeyField.getPassword()));
    }
