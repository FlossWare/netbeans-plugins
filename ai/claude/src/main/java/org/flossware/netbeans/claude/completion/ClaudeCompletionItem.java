...
/**
 * Individual completion item from Claude
 */
public class ClaudeCompletionItem implements CompletionItem {
    ...
    public ClaudeCompletionItem(String text, String prefix, int caretOffset, int priority) {
        this.text = text;
        this.prefix = prefix;
    ...
    private static ImageIcon loadIcon() {
        // Try to load Claude icon, fallback to default
        ImageIcon icon = ImageUtilities.loadImageIcon(
                "org/flossware/netbeans/claude/resources/claude-icon.png", false);
        return icon;
    }
    ...
    public CompletionTask createDocumentationTask() {
        return new ClaudeCompletionDocumentation(text);
    }
