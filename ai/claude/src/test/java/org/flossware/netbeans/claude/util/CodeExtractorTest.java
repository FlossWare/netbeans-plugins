...
class CodeExtractorTest {
    ...
    @Test
    void testExtractCodeBlocks_NullString() {
        List<CodeBlock> blocks = CodeExtractor.extractCodeBlocks(null);
        assertThat(blocks).isEmpty();
    }
    ...
    @Test
    void testHasCodeBlocks_NullString() {
        assertThat(CodeExtractor.hasCodeBlocks(null)).isFalse();
    }
    ...
    @Test
    void testGetFirstCodeBlock_NullString() {
        CodeBlock first = CodeExtractor.getFirstCodeBlock(null);
        assertThat(first).isNull();
    }
    ...
    @Test
    void testStripCodeBlockMarkers_NullString() {
        String stripped = CodeExtractor.stripCodeBlockMarkers(null);
    ...
    @Test
    void testExtractCodeBlocks_CodeWithBackticks() {
        String text = "```javascript\nconst s = `template`;\n```";
        List<CodeBlock> blocks = CodeExtractor.extractCodeBlocks(text);

        assertThat(blocks).hasSize(1);
        assertThat(blocks.get(0).getCode()).contains("`template`");
    }
    ...
    @Test
    void testExtractCodeBlocks_OnlyBackticks() {
        String text = "``````";
        List<CodeBlock> blocks = CodeExtractor.extractCodeBlocks(text);
        assertThat(blocks).hasSize(1);
    }
