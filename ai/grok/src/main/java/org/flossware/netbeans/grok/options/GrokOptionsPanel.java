...
/**
 * Panel for Grok options
 */
final class GrokOptionsPanel extends JPanel {
    ...
    private final GrokOptionsPanelController controller;
    private JPasswordField apiKeyField;
    private JComboBox<String> modelComboBox;
    private JSpinner maxTokensSpinner;
    private JSpinner temperatureSpinner;

    GrokOptionsPanel(GrokOptionsPanelController controller) {
    ...
    private void initComponents() {
        ...
        gbc.gridx = 1;
        gbc.gridy = 1;
        JLabel helpLabel = new JLabel("<html><small>Get your API key from <a href='https://console.x.ai/'>console.x.ai</a></small></html>");
    ...
    void load() {
        Preferences prefs = NbPreferences.forModule(GrokOptionsPanel.class);
        apiKeyField.setText(prefs.get(PREF_API_KEY, ""));
        modelComboBox.setSelectedItem(prefs.get(PREF_MODEL, "grok-beta"));
    ...
    void store() {
        ...
        GrokService.getInstance().getClient().setApiKey(new String(apiKeyField.getPassword()));
    }
    ...
    private void testConnection() {
        ...
        // Test the connection
        GrokService service = GrokService.getInstance();
