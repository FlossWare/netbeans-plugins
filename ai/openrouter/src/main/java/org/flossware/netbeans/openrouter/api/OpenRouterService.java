...
public class OpenRouterService {
    ...
    private static OpenRouterService instance;
    private final OpenRouterClient client;
    private final RequestProcessor requestProcessor;

    private OpenRouterService() {
        this.client = new OpenRouterClient();
        this.requestProcessor = new RequestProcessor("OpenRouter API", 3);
    }

    public static synchronized OpenRouterService getInstance() {
        if (instance == null) {
