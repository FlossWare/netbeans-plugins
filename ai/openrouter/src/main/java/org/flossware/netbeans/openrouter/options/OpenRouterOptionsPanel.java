...
package org.flossware.netbeans.openrouter.options;
...
/**
 * Panel for OpenRouter options
 */
final class OpenRouterOptionsPanel extends JPanel {
    ...
    private final OpenRouterOptionsPanelController controller;
    private JPasswordField apiKeyField;
    private JComboBox<String> modelComboBox;
    private JSpinner maxTokensSpinner;
    private JSpinner temperatureSpinner;

    OpenRouterOptionsPanel(OpenRouterOptionsPanelController controller) {
    ...
    private void initComponents() {
        ...
        gbc.gridx = 1;
        gbc.gridy = 1;
        JLabel helpLabel = new JLabel("<html><small>Get your API key from <a href='https://console.openrouter.ai/'>console.openrouter.ai</a></small></html>");
        ...
        modelComboBox = new JComboBox<>(new String[]{
            ...
            "openrouter-medium-latest",
            "openrouter-small-latest",
            "codestral-latest"
        });
    ...
    void load() {
        Preferences prefs = NbPreferences.forModule(OpenRouterOptionsPanel.class);
        apiKeyField.setText(prefs.get(PREF_API_KEY, ""));
        modelComboBox.setSelectedItem(prefs.get(PREF_MODEL, "openrouter-large-latest"));
    ...
    void store() {
        ...
        OpenRouterService.getInstance().getClient().setApiKey(new String(apiKeyField.getPassword()));
    }
