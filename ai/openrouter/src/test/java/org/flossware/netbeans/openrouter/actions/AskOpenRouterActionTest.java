...
class AskOpenRouterActionTest {

    @Mock
    private JTextComponent mockComponent;

    private AskOpenRouterAction action;

    @BeforeEach
    void setUp() {
        action = new AskOpenRouterAction(mockComponent);
    }
    ...
    void testConstruction_NullComponent() {
        AskOpenRouterAction nullAction = new AskOpenRouterAction(null);
